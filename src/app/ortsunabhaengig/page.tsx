...
export const metadata: Metadata = {
  title: "Ortsunabhängig – Mach's eifach",
  description:
    "Wie ortsunabhängiges Arbeiten in der Praxis funktioniert, für Selbstständige, die ihren Arbeitsort selbst bestimmen wollen.",
};

export default function OrtsunabhaengigPage() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-16 sm:py-20">
      <div className="mb-14 text-center">
        ...
        <h1 className="mt-1.5 text-[38px] font-bold">Ortsunabhängig</h1>
        <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-[var(--muted)]">
          Wie ortsunabhängiges Arbeiten in der Praxis funktioniert, für Selbstständige, die ihren
          Arbeitsort selbst bestimmen wollen.
        </p>
      </div>

      {ortsunabhaengigPosts.length > 0 ? (
        <div className="flex flex-col gap-7">
          {ortsunabhaengigPosts.map((post) => (
            <article
              key={post.slug}
            ...
            >
              ...
              <h2 className="m-0 mb-2 text-xl font-bold">
                <Link
                  href={`/ortsunabhaengig/${post.slug}`}
